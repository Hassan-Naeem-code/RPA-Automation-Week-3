...
class InventoryProcessor:
    ...
    def generate_summary_stats(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'top_5_high_value_items': df.nlargest(5, 'TotalValue')[['SKU', 'Description', 'TotalValue']].to_dict('records'),
            'processing_stats': self.stats.copy()
        }
        
        return summary
    
    def process_inventory(self, df: pd.DataFrame, 
                         remove_duplicates: bool = True,
                         validate_rules: bool = True) -> Tuple[pd.DataFrame, Dict[str, Any], List[Dict[str, Any]]]:
        """
...
def process_inventory_data(df: pd.DataFrame, config: Optional[Dict[str, Any]] = None) -> Tuple[pd.DataFrame, Dict[str, Any], List[Dict[str, Any]]]:
    """
